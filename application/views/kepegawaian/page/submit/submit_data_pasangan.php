			...
			echo form_open('pekerja/submit_data_pasangan/', $attributes) ?>
                <fieldset class="step" id="w2first">
					...
					<div class="formRow">
                        ...
                        <div class="formRight"><input type="text" name="tanggal_psgn" id="tanggal_psgn" class="maskDate"/></div>
                        <div class="clear"></div>
                    </div>
					<div class="formRow">
                        <label>Tanggal Meninggal:</label>
                        <div class="formRight"><input type="text" name="meninggal_psgn" id="meninggal_psgn" class="maskDate"/></div>
                        <div class="clear"></div>
                    </div>
					<div class="formRow">
