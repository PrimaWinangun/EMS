	...
	<div class="widget">
			...
			echo form_open('pekerja/submit_data_mertua/', $attributes) ?>
				...
				<fieldset class="step" id="w3confirmation">
					...
					<div class="formRow">
                        <label>Tanggal Lahir:</label>
                        <div class="formRight"><input type="text" name="tanggal_mert_ibu" id="tanggal_mert_ibu" class="maskDate"/></div>
                        <div class="clear"></div>
                    </div>
					<div class="formRow">
                        <label>Tanggal Meninggal:</label>
                        <div class="formRight"><input type="text" name="meninggal_mert_ibu" id="meninggal_mert_ibu" class="maskDate"/></div>
                        <div class="clear"></div>
                    </div>
					<div class="formRow">
                        <label>Alamat:</label>
